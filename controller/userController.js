...
export const getUserForPortfolio = catchAsyncErrors(async (req, res, next) => {
  const id = "6884f4ab430d4f1ee0972fbd";
...
import Upload from "../models/Upload.js"; // ✅ not User

export const uploadImageWithTitle = catchAsyncErrors(async (req, res, next) => {
